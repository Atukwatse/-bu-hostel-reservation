...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'country_code', 'role', 'gender', 'student_reg_no', 'program_of_study',
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'last_name', 'phone', 'country_code', 'gender', 'student_reg_no',
            'program_of_study', 'year_of_study', 'next_of_kin_name',
            'next_of_kin_phone', 'next_of_kin_country_code'
        ]

    def validate_student_reg_no(self, value):
        if value:
            import re
            pattern = r'^\d{2}/[A-Za-z]+/BU/R/\d{4}$'
            if not re.match(pattern, value, re.IGNORECASE):
                raise serializers.ValidationError(
                    "Invalid Registration Number format. Format must be YY/COURSE/BU/R/XXXX (e.g., 24/BSE/BU/R/0008)."
                )
            return value.upper()
        return value
...
class UserUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'student_reg_no', 'program_of_study', 'year_of_study',
